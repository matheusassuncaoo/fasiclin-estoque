...
public class MovContabilController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Movimentação encontrada com sucesso",
                content = @Content(mediaType = "application/json", schema = @Schema(implementation = MovContabil.class))),
    ...
    public ResponseEntity<MovContabil> findById(
            @Parameter(description = "ID da movimentação contábil", required = true)
    ...
    public ResponseEntity<MovContabil> create(
            @Parameter(description = "Dados da movimentação contábil", required = true)
            @Valid @RequestBody MovContabil movContabil) {
        try {
    ...
    public ResponseEntity<Void> deleteById(
            @Parameter(description = "ID da movimentação a ser removida", required = true)
            @PathVariable @NotNull Integer id) {
        try {
    ...
    public ResponseEntity<List<MovContabil>> findByNumeroLancamento(
            @Parameter(description = "Número do lançamento", required = true)
            @PathVariable @NotNull Integer numeroLancamento) {
        try {
    ...
    public ResponseEntity<List<MovContabil>> findByIdPlanoConta(
            ...
            @PathVariable @NotNull Integer idPlanoConta) {
        try {
    ...
    public ResponseEntity<List<MovContabil>> findByIdOrdComp(
            ...
            @PathVariable @NotNull Integer idOrdComp) {
        try {
    ...
    public ResponseEntity<List<MovContabil>> findByDataLancamento(
            @Parameter(description = "Data do lançamento (formato: yyyy-MM-dd)", required = true)
            @PathVariable @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate dataLancamento) {
        try {
    ...
    public ResponseEntity<List<MovContabil>> findByTipo(
            @Parameter(description = "Tipo da movimentação (D ou C)", required = true)
