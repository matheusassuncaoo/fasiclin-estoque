 ...
 * 
 * <p>Fornece endpoints para operações CRUD e consultas especializadas
 * relacionadas ao controle de inventário do sistema de estoque.</p>
 * 
...
public class EstoqueController {
    ...
    @Operation(summary = "Buscar registro de estoque por ID", 
               description = "Retorna um registro específico de estoque baseado no ID fornecido")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Registro de estoque encontrado",
    ...
    @Operation(summary = "Listar todos os registros de estoque", 
               description = "Retorna uma lista completa de todos os registros de estoque")
    ...
    @Operation(summary = "Criar novo registro de estoque", 
               description = "Cria um novo registro de estoque no sistema")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Registro de estoque criado com sucesso",
                    content = @Content(schema = @Schema(implementation = Estoque.class))),
    ...
    public ResponseEntity<Estoque> create(
            @Parameter(description = "Dados do registro de estoque", required = true)
     ...
     */
    @Operation(summary = "Atualizar registro de estoque", 
               description = "Atualiza os dados de um registro de estoque existente")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Registro de estoque atualizado com sucesso",
                    content = @Content(schema = @Schema(implementation = Estoque.class))),
        @ApiResponse(responseCode = "404", description = "Registro de estoque não encontrado"),
        @ApiResponse(responseCode = "400", description = "Dados inválidos fornecidos"),
        @ApiResponse(responseCode = "422", description = "Erro de validação de negócio")
    ...
    public ResponseEntity<Estoque> update(
            @Parameter(description = "ID do registro de estoque", required = true)
            @PathVariable @NotNull @Min(1) Integer id,
            @Parameter(description = "Novos dados do registro de estoque", required = true)
            @Valid @RequestBody Estoque estoque) {
        estoque.setId(id);
     ...
     */
    @Operation(summary = "Remover registro de estoque", 
               description = "Remove um registro de estoque do sistema")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Buscar estoque por produto", 
               description = "Retorna todos os registros de estoque de um produto específico")
    @ApiResponses(value = {
     ...
     */
    @Operation(summary = "Buscar estoque por lote", 
               description = "Retorna todos os registros de estoque de um lote específico")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Registros encontrados com sucesso"),
    ...
    public ResponseEntity<List<Estoque>> findByIdLote(
            ...
            @PathVariable @NotNull @Min(1) Integer idLote) {
     ...
     */
    @Operation(summary = "Buscar por quantidade específica", 
               description = "Retorna registros com quantidade exata especificada")
    @GetMapping("/quantidade/{quantidade}")
    public ResponseEntity<List<Estoque>> findByQuantidade(
            @Parameter(description = "Quantidade em estoque", required = true)
            @PathVariable @NotNull @PositiveOrZero Integer quantidade) {
     ...
     */
    @Operation(summary = "Buscar por faixa de quantidade", 
               description = "Retorna registros com quantidade dentro da faixa especificada")
    @GetMapping("/quantidade")
    public ResponseEntity<List<Estoque>> findByQuantidadeBetween(
            @Parameter(description = "Quantidade mínima", required = true)
            @RequestParam @NotNull @PositiveOrZero Integer quantidadeMin,
            @Parameter(description = "Quantidade máxima", required = true)
            @RequestParam @NotNull @PositiveOrZero Integer quantidadeMax) {
     ...
     */
    @Operation(summary = "Buscar estoque baixo", 
               description = "Retorna registros com quantidade abaixo do limite especificado")
    @GetMapping("/baixo")
    public ResponseEntity<List<Estoque>> findEstoqueBaixo(
            @Parameter(description = "Quantidade mínima considerada como estoque baixo", required = true)
            @RequestParam @NotNull @Positive Integer quantidadeMinima) {
     ...
     */
    @Operation(summary = "Buscar estoque zerado", 
               description = "Retorna todos os registros com quantidade zero")
    @GetMapping("/zerado")
     ...
     */
    @Operation(summary = "Contar registros por produto", 
               description = "Retorna a quantidade de registros de estoque de um produto")
     ...
     */
    @Operation(summary = "Somar quantidade total por produto", 
               description = "Retorna a quantidade total em estoque de um produto (todos os lotes)")
    ...
    public ResponseEntity<Estoque> adicionarEstoque(
            @Parameter(description = "ID do produto", required = true)
            @RequestParam @NotNull @Min(1) Integer idProduto,
            @Parameter(description = "ID do lote (opcional)")
